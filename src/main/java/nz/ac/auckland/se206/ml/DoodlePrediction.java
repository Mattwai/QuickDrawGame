...
public class DoodlePrediction {
  ...
  public static String returnPredictions(final List<Classifications.Classification> predictions) {
    final StringBuilder sb = new StringBuilder();
    // gets and styles the predictions from ml model
    int i = 1;
    ...
    // returns list of predictions as a string so that it can be printed in the gui
    return sb.toString();
  }
